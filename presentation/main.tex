...
\begin{frame}[c]
	...
	\begin{columns}
		...
		\column{.3333\textwidth}
		\begin{figure}
			\includegraphics[width=.9\textwidth]{../images/introduction/scenario2}
		\end{figure}
		\column{.3333\textwidth}
		\textbf{WSN}
		\begin{itemize}
...
\begin{frame}[c]
	...
	\begin{columns}
		\column{.5\textwidth}
		\begin{figure}
			\includegraphics[width=0.7\textwidth, trim = 0mm 30mm 0mm 20mm, clip]{../images/model/spectrum}
		\end{figure}
		\begin{center}
			$\Downarrow$
		\end{center}
		\begin{figure}
			\includegraphics[width=0.5\textwidth, trim = 0mm 0mm 0mm 20mm, clip]{../images/model/globalview}
		\end{figure}
		\column{.5\textwidth}
...
\begin{frame}[c]
	...
	\begin{columns}[c]
		...
		\column{.5\textwidth}
			\begin{figure}
				\includegraphics[width=0.8\textwidth]{../images/model/localview}
			\end{figure}
	\end{columns}
...
\begin{frame}[c]
	...
	\begin{columns}
		...
		\column{.5\textwidth}
			...
			\begin{figure}
				\centering
				\includegraphics[width=1\textwidth]{../images/results/GlobalView/flows/n_tests}
			\end{figure}
	\end{columns}
